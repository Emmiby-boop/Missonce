...
Page({
  ...
  async saveProfile() {
    ...
    try {
      ...
      const merged = { ...getStorage('userInfo'), nickName: nick, avatarUrl: avatarFinal, openid }
      setStorage('userInfo', merged)
      
      const userCache = getStorage('user') || {}
      setStorage('user', { ...userCache, nickName: nick, avatarUrl: avatarFinal, _id: openid })
