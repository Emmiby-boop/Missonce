<template>
  <footer class="footer footer-center bg-[var(--bg-body)] p-10 text-[var(--text-main)] transition-colors duration-300">
    <div>
      ...
      <div class="flex flex-col items-center">
        <p class="mt-4 text-[var(--text-sub)]">基于 Vue + Vite + CloudBase 构建</p>
        <div class="mt-4">
          <a
        ...
        <p class="mt-2 text-xs text-[var(--text-sub)] opacity-50">
...
<style scoped>
.btn-icon {
  @apply p-2 rounded-full text-[var(--text-sub)] hover:text-[var(--primary)] transition-colors duration-200;
}
.btn-icon:hover {
